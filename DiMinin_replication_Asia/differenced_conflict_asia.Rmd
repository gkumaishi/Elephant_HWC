...
savepol <- function(x){
  ...
  writeVector(x, filename = here(HWC_data, "/Geospatial Data/Diminin_Replication_Data/differenced_polygons_asia/", name), overwrite = TRUE)
  
}

#SSP1

ssp1_rcp26_2050_diff_polygon <- rast(here(HWC_data, "/Geospatial Data/Diminin_Replication_Data/differenced_rasters_asia/ssp1_rcp26_2050_diff.tif")) %>% 
...
ssp3_rcp70_2050_diff_polygon <- rast(here(HWC_data, "/Geospatial Data/Diminin_Replication_Data/differenced_rasters_asia/ssp3_rcp70_2050_diff.tif")) %>% 
  terra::as.polygons(trunc=TRUE, dissolve=TRUE, values=TRUE, na.rm=TRUE, na.all=FALSE, extent=FALSE)
