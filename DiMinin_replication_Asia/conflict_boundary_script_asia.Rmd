---
title: "Projection Wrangling Script Asia"
...
lulc <- rast(here(HWC_data, "/Geospatial Data/Diminin_Replication_Data/cropped_lulc/lulc_asia.tif"))
...
#asia_vect <- vect(here(HWC_data, "/R_files/R_output_data/indomalay_region/indomalay_region.shp"))
#asia <- project(asia_vect, "epsg:9001")

popdens_asia <- mask(popdens, lulc)
...
ranked_conflict_masked <- mask(ranked_conflict, lulc)
