...
human_dens <- rast(here(HWC_data, "/Geospatial Data/Diminin_Replication_Data/pop_density/wpop_2015_top10.tif"))
...
writeRaster(ranked_conflict_masked, filename = here(HWC_data, "/Geospatial Data/Diminin_Replication_Data/ranked_pressure_layers/wp2015_current_day_rp.tif"), filetype = "GTiff", overwrite = TRUE)
...
ranked_press <- rast(here(HWC_data, "/Geospatial Data/Diminin_Replication_Data/ranked_pressure_layers/wp2015_current_day_rp.tif")) %>% 
...
writeRaster(conflict_int, filename = here(HWC_data, "/Geospatial Data/Diminin_Replication_Data/conflict_boundaries/wp2015_current_day_cb_raster.tif"), filetype = "GTiff", overwrite = TRUE)
...
current_cb <- rast(here(HWC_data, "/Geospatial Data/Diminin_Replication_Data/conflict_boundaries/wp2015_current_day_cb_raster.tif"))
...
st_write(current_cb_line, dsn = here(HWC_data, "/Geospatial Data/Diminin_Replication_Data/conflict_boundaries/wp2015_current_day_cb_lines.shp"))
