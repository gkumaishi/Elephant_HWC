...
human_dens <- rast(here(HWC_data, "/Geospatial Data/Diminin_Replication_Data/pop_density/top10_pop.tif"))
...
writeRaster(ranked_conflict_masked, filename = here(HWC_data, "/Geospatial Data/Diminin_Replication_Data/ranked_pressure_layers/current_day_rp.tif"), filetype = "GTiff", overwrite = TRUE)
...
writeRaster(conflict_int, filename = here(HWC_data, "/Geospatial Data/Diminin_Replication_Data/conflict_boundaries/current_day_cb_raster.tif"), filetype = "GTiff", overwrite = TRUE)
...
current_cb <- rast(here(HWC_data, "/Geospatial Data/Diminin_Replication_Data/conflict_boundaries/current_day_cb_raster.tif"))
