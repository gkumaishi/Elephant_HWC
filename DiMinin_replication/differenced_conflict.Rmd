...
polygons <- function(ssp, rcp, year){
  ...
  pol <- rast(here(HWC_data, "/Geospatial Data/Diminin_Replication_Data/differenced_rasters/", file)) %>%
  ...
  writeVector(pol, filename = here(HWC_data, "/Geospatial Data/Diminin_Replication_Data/differenced_polygons/", name), overwrite = TRUE)
...
perc_area_table <- function(x){
  ...
  diff_pol <- read_sf(here(HWC_data, "/Geospatial Data/Diminin_Replication_Data/differenced_polygons", x))
...
pol_list <- list.files(path = here(HWC_data, "/Geospatial Data/Diminin_Replication_Data/differenced_polygons"), pattern = '.shp')
...
save_kable(conf_change_pols_nicetable, file = here("/Users/mia/Desktop/Fellowships/Arnhold HWC/conf_change_polygons_table_byyear_africa.jpeg"))
```
...
```{r}
s1_inc <- conf_change_table_pol_year$"SSP1 2050"[[4]] + conf_change_table_pol_year$"SSP1 2050"[[5]]

s3_inc <- conf_change_table_pol_year$"SSP3 2050"[[4]] + conf_change_table_pol_year$"SSP3 2050"[[5]]

diff <- s3_inc - s1_inc

s1_dec <- conf_change_table_pol_year$"SSP1 2050"[[1]] + conf_change_table_pol_year$"SSP1 2050"[[2]]

s3_dec <- conf_change_table_pol_year$"SSP3 2050"[[1]] + conf_change_table_pol_year$"SSP3 2050"[[2]]
