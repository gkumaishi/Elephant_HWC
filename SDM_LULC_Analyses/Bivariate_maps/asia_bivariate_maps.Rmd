...
factor <- ceiling(res(sdm)[1]/res(chen)[1])
```{r}
factor <- ceiling(res(sdm_126_2020_reclass)[1]/res(cropland_126_2020)[1])

cropland_126_2020_agg <- terra::aggregate(cropland_126_2020, fact = factor, fun = mean, na.rm = TRUE)
...
```{r}
factor <- ceiling(res(sdm_585_2020_reclass)[1]
                  /res(cropland_585_2020)[1])

cropland_585_2020_agg <- terra::aggregate(cropland_585_2020, fact = factor, fun = mean, na.rm = TRUE)
...
```{r}
writeRaster(sdm_change_ag_585_2020, paste0(HWC_data, "/Geospatial Data/bivariate_outputs/asel_bivariate_sdm_change_585_2020.tif"), overwrite = TRUE)
```
...
```{r}
factor <- ceiling(res(sdm_585_2050_reclass)[1]
                  /res(cropland_585_2050)[1])

cropland_585_2050_agg <- terra::aggregate(cropland_585_2050, fact = factor, fun = mean, na.rm = TRUE)
...
```{r}
writeRaster(sdm_change_ag_585_2050, paste0(HWC_data, "/Geospatial Data/bivariate_outputs/asel_bivariate_sdm_change_585_2050.tif"), overwrite = TRUE)
```
...
```{r}
factor <- ceiling(res(sdm_126_2080_reclass)[1]
                  /res(cropland_126_2080)[1])

cropland_126_2080_agg <- terra::aggregate(cropland_126_2080, fact = factor, fun = mean, na.rm = TRUE)
...
#### Write the file to a .tif to export to QGIS
```{r}
writeRaster(sdm_change_ag_126_2080, paste0(HWC_data, "/Geospatial Data/bivariate_outputs/asel_bivariate_sdm_change_126_2080.tif"), overwrite = TRUE)
```
...
```{r}
factor <- ceiling(res(sdm_585_2080_reclass)[1]
                  /res(cropland_585_2080)[1])

cropland_585_2080_agg <- terra::aggregate(cropland_585_2080, fact = factor, fun = mean, na.rm = TRUE)
...
```{r}
writeRaster(sdm_change_ag_585_2080, paste0(HWC_data, "/Geospatial Data/bivariate_outputs/asel_bivariate_sdm_change_585_2080.tif"), overwrite = TRUE)
```
