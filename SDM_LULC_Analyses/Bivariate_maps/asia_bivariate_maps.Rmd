...
blueRedScale <- c("#e8e8e8","#e4acac", "#c85a5a", "#b0d5df", "#ad9ea5", "#985356", "#64acbe", "#627f8c", "#574249")

plot(as.factor(baseline_bivariate_indomalaya), main = "Baseline SDM and Cropland", type = "classes", col = blueOrangeScale)
```

#### Write the file to a .tif to export to QGIS
```{r}
writeRaster(baseline_bivariate_indomalaya, paste0(HWC_data, "/Geospatial Data/bivariate_outputs/asel_bivariate_baseline.tif"), overwrite = TRUE)
```
...
```{r}
sdm_126_2020 <- rast(paste0(HWC_data, "/Wallace SDM Rasters/asia/2011_2040/126/gfdl_2011_2040_126_sdm.tif"))
...
#### SDM raster does not have an extent, so we're going to assign it (found by importing to QGIS)
```{r}
ext(sdm_126_2020) <- c(65.8581934609999990,
                       131.0665265334999958,
                       -12.2168058669999979,
                       35.8248606080000016)
```
...
sdm_126_2020_reproj_as <- sdm_126_2020 %>% 
  project(crs(lu_126_2020), method = "bilinear")
...
#### Crop land use to asia
```{r}
lu_126_2020_as <- crop(lu_126_2020, sdm_126_2020_reclass)
plot(lu_126_2020_as)
```
...
#### Raster math - Cropland change vs SDM (SSP1/RCP2.6, 2025)
```{r}
as_bivar_126_2020 <- as.factor(sdm_126_2020_resamp + cropland_126_2020_factor)
...
plot(as_bivar_126_2020, main = "SDM and Cropland in 2025
...
#### Write the file to a .tif to export to QGIS
```{r}
writeRaster(as_bivar_126_2020, paste0(HWC_data, "/Geospatial Data/bivariate_outputs/asel_bivariate_126_2020.tif"), overwrite = TRUE)
```
...
#### Read in land use and SDM
```{r}
sdm_370_2020 <- rast(paste0(HWC_data, "/Wallace SDM Rasters/asia/2011_2040/370/gfdl_2011_2040_370_sdm.tif"))
...
#### SDM raster does not have an extent, so we're going to assign it (found by importing to QGIS)
```{r}
ext(sdm_370_2020) <- c(65.8581934609999990,
                       131.0665265334999958,
                       -12.2168058669999979,
                       35.8248606080000016)
```
...
#### Re-project the SDM to have the same CRS as the land use
```{r}
sdm_370_2020_reproj_as <- sdm_370_2020 %>% 
  project(crs(lu_370_2020), method = "bilinear")

plot(sdm_370_2020_reproj_as)
```

#### Reclassify values of the SDM Change map
```{r}
sdm_370_2020_reclass <- sdm_370_2020_reproj_as
...
#### Crop land use to asia
```{r}
lu_370_2020_as <- crop(lu_370_2020, sdm_370_2020_reclass)
plot(lu_370_2020_as)
```
...
We want cropland (category 5) to be 1, everything else to be 0
```{r}
cropland_370_2020 <- lu_370_2020_as
...
#### Raster math - Cropland change vs SDM (SSP3/RCP7.0, 2025)
```{r}
as_bivar_370_2020 <- as.factor(sdm_370_2020_resamp + cropland_370_2020_factor)
...
plot(as_bivar_370_2020, main = "SDM and Cropland in 2025
...
#### Write the file to a .tif to export to QGIS
```{r}
writeRaster(as_bivar_370_2020, paste0(HWC_data, "/Geospatial Data/bivariate_outputs/asel_bivariate_370_2020.tif"), overwrite = TRUE)
```
...
#### Read in land use and SDM
```{r}
sdm_585_2020 <- rast(paste0(HWC_data, "/Wallace SDM Rasters/asia/2041_2070/585/gfdl_2041_2070_585_sdm.tif"))
lu_585_2020 <- rast(paste0(HWC_data, "/Geospatial Data/Chen_LULC_data/SSP5_RCP85/global_SSP5_RCP85_2055.tif"))
```
...
sdm_585_2020_reproj_as <- sdm_585_2020 %>% 
  project(crs(lu_585_2020), method = "bilinear")
...
sdm_585_2020_reclass[sdm_585_2020_reclass >= 0 & sdm_585_2020_reclass < 0.33] <- 10
sdm_585_2020_reclass[sdm_585_2020_reclass >= 0.33 & sdm_585_2020_reclass < 0.66] <- 20
sdm_585_2020_reclass[sdm_585_2020_reclass >=0.66 & sdm_585_2020_reclass <= 1] <- 30

plot(sdm_585_2020_reclass)
```
...
#### Crop land use to asia
```{r}
lu_585_2020_as <- crop(lu_585_2020, sdm_585_2020_reclass)
plot(lu_585_2020_as)
```
...
We want cropland (category 5) to be 1, everything else to be 0
```{r}
cropland_585_2020 <- lu_585_2020_as
...
#### Raster math - Cropland change vs SDM (SSP5/RCP8.5, 2025)
```{r}
as_bivar_585_2020 <- as.factor(sdm_585_2020_resamp + cropland_585_2020_factor)
...
plot(as_bivar_585_2020, main = "SDM and Cropland in 2025
...
#### Write the file to a .tif to export to QGIS
```{r}
writeRaster(as_bivar_585_2020, paste0(HWC_data, "/Geospatial Data/bivariate_outputs/asel_bivariate_585_2020.tif"), overwrite = TRUE)
```
...
#### Read in land use and SDM
```{r}
sdm_126_2050 <- rast(paste0(HWC_data, "/Wallace SDM Rasters/asia/2071_2100/126/gfdl_2071_2100_126_sdm.tif"))
lu_126_2050 <- rast(paste0(HWC_data, "/Geospatial Data/Chen_LULC_data/SSP1_RCP26/global_SSP1_RCP26_2085.tif"))
```
...
#### SDM raster does not have an extent, so we're going to assign it (found by importing to QGIS)
```{r}
ext(sdm_126_2050) <- c(65.8581934609999990,
                       131.0665265334999958,
                       -12.2168058669999979,
                       35.8248606080000016)
```
...
sdm_126_2050_reproj_as <- sdm_126_2050 %>% 
  project(crs(lu_126_2050), method = "bilinear")
...
#### Crop land use to asia
```{r}
lu_126_2050_as <- crop(lu_126_2050, sdm_126_2050_reclass)
plot(lu_126_2050_as)
```
...
We want cropland (category 5) to be 1, everything else to be 0
```{r}
cropland_126_2050 <- lu_126_2050_as
...
#### Raster math - Cropland change vs SDM (SSP1/RCP2.6, 2055)
```{r}
as_bivar_126_2050 <- as.factor(sdm_126_2050_resamp + cropland_126_2050_factor)
...
plot(as_bivar_126_2050, main = "SDM and Cropland in 2055
     SSP1 RCP2.6", type = "classes", col = blueOrangeScale)
```
...
#### Write the file to a .tif to export to QGIS
```{r}
writeRaster(as_bivar_126_2050, paste0(HWC_data, "/Geospatial Data/bivariate_outputs/asel_bivariate_126_2050.tif"), overwrite = TRUE)
```
...
#### Read in land use and SDM
```{r}
sdm_370_2050 <- rast(paste0(HWC_data, "/Wallace SDM Rasters/asia/2071_2100/370/gfdl_2071_2100_370_sdm.tif"))
lu_370_2050 <- rast(paste0(HWC_data, "/Geospatial Data/Chen_LULC_data/SSP3_RCP70/global_SSP3_RCP70_2085.tif"))
```
...
#### SDM raster does not have an extent, so we're going to assign it (found by importing to QGIS)
```{r}
ext(sdm_370_2050) <- c(65.8581934609999990,
                       131.0665265334999958,
                       -12.2168058669999979,
                       35.8248606080000016)
```
...
#### Re-project the SDM to have the same CRS as the land use
```{r}
sdm_370_2050_reproj_as <- sdm_370_2050 %>% 
  project(crs(lu_370_2050), method = "bilinear")

plot(sdm_370_2050_reproj_as)
```

#### Reclassify values of the SDM Change map
```{r}
sdm_370_2050_reclass <- sdm_370_2050_reproj_as
...
#### Crop land use to asia
```{r}
lu_370_2050_as <- crop(lu_370_2050, sdm_370_2050_reclass)
plot(lu_370_2050_as)
```
...
We want cropland (category 5) to be 1, everything else to be 0
```{r}
cropland_370_2050 <- lu_370_2050_as
...
#### Raster math - Cropland change vs SDM (SSP3/RCP7.0, 2085)
```{r}
as_bivar_370_2050 <- as.factor(sdm_370_2050_resamp + cropland_370_2050_factor)
...
plot(as_bivar_370_2050, main = "SDM and Cropland in 2085
     SSP3 RCP7.0", type = "classes", col = blueOrangeScale)
```
...
#### Write the file to a .tif to export to QGIS
```{r}
writeRaster(as_bivar_370_2050, paste0(HWC_data, "/Geospatial Data/bivariate_outputs/asel_bivariate_370_2050.tif"), overwrite = TRUE)
```
...
#### Read in land use and SDM
```{r}
sdm_585_2050 <- rast(paste0(HWC_data, "/Wallace SDM Rasters/asia/2041_2070/585/gfdl_2041_2070_585_sdm.tif"))
...
sdm_585_2050_reproj_as <- sdm_585_2050 %>% 
  project(crs(lu_585_2050), method = "bilinear")
...
#### Crop land use to asia
```{r}
lu_585_2050_as <- crop(lu_585_2050, sdm_585_2050_reclass)
plot(lu_585_2050_as)
```
...
We want cropland (category 5) to be 1, everything else to be 0
```{r}
cropland_585_2050 <- lu_585_2050_as
...
#### Raster math - Cropland change vs SDM (SSP5/RCP8.5, 2055)
```{r}
as_bivar_585_2050 <- as.factor(sdm_585_2050_resamp + cropland_585_2050_factor)
...
plot(as_bivar_585_2050, main = "SDM and Cropland in 2055
     SSP5 RCP8.5", type = "classes", col = blueOrangeScale)
```
...
#### Write the file to a .tif to export to QGIS
```{r}
writeRaster(as_bivar_585_2050, paste0(HWC_data, "/Geospatial Data/bivariate_outputs/asel_bivariate_585_2050.tif"), overwrite = TRUE)
```
...
#### Read in land use and SDM
```{r}
sdm_126_2080 <- rast(paste0(HWC_data, "/Wallace SDM Rasters/asia/2071_2100/126/gfdl_2071_2100_126_sdm.tif"))
...
#### SDM raster does not have an extent, so we're going to assign it (found by importing to QGIS)
```{r}
ext(sdm_126_2080) <- c(65.8581934609999990,
                       131.0665265334999958,
                       -12.2168058669999979,
                       35.8248606080000016)
```
...
sdm_126_2080_reproj_as <- sdm_126_2080 %>% 
  project(crs(lu_126_2080), method = "bilinear")
...
#### Crop land use to asia
```{r}
lu_126_2080_as <- crop(lu_126_2080, sdm_126_2080_reclass)
plot(lu_126_2080_as)
```
...
We want cropland (category 5) to be 1, everything else to be 0
```{r}
cropland_126_2080 <- lu_126_2080_as
...
#### Raster math - Cropland change vs SDM (SSP1/RCP2.6, 2085)
```{r}
as_bivar_126_2080 <- as.factor(sdm_126_2080_resamp + cropland_126_2080_factor)
...
plot(as_bivar_126_2080, main = "SDM and Cropland in 2085
     SSP1 RCP2.6", type = "classes", col = blueOrangeScale)
```
...
#### Write the file to a .tif to export to QGIS
```{r}
writeRaster(as_bivar_126_2080, paste0(HWC_data, "/Geospatial Data/bivariate_outputs/asel_bivariate_126_2080.tif"), overwrite = TRUE)
```
...
#### Read in land use and SDM
```{r}
sdm_370_2080 <- rast(paste0(HWC_data, "/Wallace SDM Rasters/asia/2071_2100/370/gfdl_2071_2100_370_sdm.tif"))
...
#### SDM raster does not have an extent, so we're going to assign it (found by importing to QGIS)
```{r}
ext(sdm_370_2080) <- c(65.8581934609999990,
                       131.0665265334999958,
                       -12.2168058669999979,
                       35.8248606080000016)
```
...
#### Re-project the SDM to have the same CRS as the land use
```{r}
sdm_370_2080_reproj_as <- sdm_370_2080 %>% 
  project(crs(lu_370_2080), method = "bilinear")

plot(sdm_370_2080_reproj_as)
```

#### Reclassify values of the SDM Change map
```{r}
sdm_370_2080_reclass <- sdm_370_2080_reproj_as
...
#### Crop land use to asia
```{r}
lu_370_2080_as <- crop(lu_370_2080, sdm_370_2080_reclass)
plot(lu_370_2080_as)
```
...
We want cropland (category 5) to be 1, everything else to be 0
```{r}
cropland_370_2080 <- lu_370_2080_as
...
#### Raster math - Cropland change vs SDM (SSP3/RCP7.0, 2085)
```{r}
as_bivar_370_2080 <- as.factor(sdm_370_2080_resamp + cropland_370_2080_factor)
...
plot(as_bivar_370_2080, main = "SDM and Cropland in 2085
     SSP3 RCP7.0", type = "classes", col = blueOrangeScale)
```
...
#### Write the file to a .tif to export to QGIS
```{r}
writeRaster(as_bivar_370_2080, paste0(HWC_data, "/Geospatial Data/bivariate_outputs/asel_bivariate_370_2080.tif"), overwrite = TRUE)
```
...
#### Read in land use and SDM
```{r}
sdm_585_2080 <- rast(paste0(HWC_data, "/Wallace SDM Rasters/asia/2071_2100/585/gfdl_2071_2100_585_sdm.tif"))
...
sdm_585_2080_reproj_as <- sdm_585_2080 %>% 
  project(crs(lu_585_2080), method = "bilinear")
...
#### Crop land use to asia
```{r}
lu_585_2080_as <- crop(lu_585_2080, sdm_585_2080_reclass)
plot(lu_585_2080_as)
```
...
We want cropland (category 5) to be 1, everything else to be 0
```{r}
cropland_585_2080 <- lu_585_2080_as
...
#### Raster math - Cropland change vs SDM (SSP5/RCP8.5, 2085)
```{r}
as_bivar_585_2080 <- as.factor(sdm_585_2080_resamp + cropland_585_2080_factor)
...
plot(as_bivar_585_2080, main = "SDM and Cropland in 2085
     SSP5 RCP8.5", type = "classes", col = blueOrangeScale)
```
...
#### Write the file to a .tif to export to QGIS
```{r}
writeRaster(as_bivar_585_2080, paste0(HWC_data, "/Geospatial Data/bivariate_outputs/asel_bivariate_585_2080.tif"), overwrite = TRUE)
```
...
#### Crop land use to asia
```{r}
lu_126_2050_as <- lu_126_2050 %>% crop(sdm_126_2050_reclass)
plot(lu_126_2050_as)
```
...
```{r}
lu_585_2050_as <- lu_585_2050 %>% crop(sdm_585_2050_reclass)
plot(lu_585_2050_as)
```
...
```{r}
lu_126_2080_as <- lu_126_2080 %>% crop(sdm_126_2080_reclass)
plot(lu_126_2080_as)
```
...
```{r}
lu_585_2080_as <- lu_585_2080 %>% crop(sdm_585_2080_reclass)
plot(lu_585_2080_as)
```
