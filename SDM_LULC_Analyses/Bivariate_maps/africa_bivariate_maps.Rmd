...
cropland_126_2020_agg <- terra::aggregate(x = cropland_126_2020, fact = factor, fun = mean, na.rm = TRUE)
...
#### Aggregate cropland
```{r}
factor <- ceiling(res(sdm_585_2020_reclass)[1]/res(cropland_585_2020)[1])

cropland_585_2020_agg <- terra::aggregate(x = cropland_585_2020, fact = factor, fun = mean, na.rm = TRUE)
...
#### Write the file to a .tif to export to QGIS
```{r}
writeRaster(sdm_change_ag_585_2020, paste0(HWC_data, "/Geospatial Data/bivariate_outputs/afel_bivariate_change_126_2020.tif"), overwrite = TRUE)
```
...
#### Read in the PROJECTED land use and SDM
```{r}
sdm_126_2050 <- rast(paste0(HWC_data, "/Wallace SDM Rasters/LQ/2041_2070/126/change_maps/afel_change_2011_2040_126_gfdl.tif"))
...
#### Write the file to a .tif to export to QGIS
```{r}
writeRaster(sdm_change_ag_585_2080, paste0(HWC_data, "/Geospatial Data/bivariate_outputs/afel_bivariate_change_585_2080.tif"), overwrite = TRUE)
```
