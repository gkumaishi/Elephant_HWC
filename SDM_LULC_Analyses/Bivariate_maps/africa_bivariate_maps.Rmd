...
#### Write the file to a .tif to export to QGIS
```{r}
writeRaster(sdm_change_ag_126_2020, paste0(HWC_data, "/Geospatial Data/bivariate_outputs/afel_sdm_change_ag_126_2020.tif"), overwrite = TRUE)
```
...
plot(sdm_change_ag_585_2020, main = "SDM Change and Cropland in 2025 
     SSP5 RCP8.5", type = "classes", col = sdmRYGscale)
```

#### Write the file to a .tif to export to QGIS
```{r}
writeRaster(sdm_change_ag_585_2020, paste0(HWC_data, "/Geospatial Data/bivariate_outputs/afel_sdm_change_ag_585_2020.tif"), overwrite = TRUE)
```
...
#### Write the file to a .tif to export to QGIS
```{r}
writeRaster(sdm_change_ag_585_2050, paste0(HWC_data, "/Geospatial Data/bivariate_outputs/afel_sdm_change_ag_585_2050.tif"), overwrite = TRUE)
```
...
plot(sdm_change_ag_126_2080, main = "SDM Change and Cropland in 2055
     SSP1 RCP2.6", type = "classes", col = sdmRYGscale)
```
...
plot(sdm_change_ag_126_2080, main = "SDM and Cropland in 2055
     SSP1 RCP2.6", type = "classes", col = sdmRYGscale)
```
...
#### Write the file to a .tif to export to QGIS
```{r}
writeRaster(sdm_change_ag_126_2080, paste0(HWC_data, "/Geospatial Data/bivariate_outputs/afel_bivariate_126_2080.tif"), overwrite = TRUE)
```
...
#### Write the file to a .tif to export to QGIS
```{r}
writeRaster(sdm_change_ag_585_2080, paste0(HWC_data, "/Geospatial Data/bivariate_outputs/afel_sdm_change_ag_585_2080.tif"), overwrite = TRUE)
```
...
plot(sdm_change_ag_585_2080, main = "SDM and Cropland in 2085
     SSP5 RCP8.5", type = "classes", col = sdmRYGscale)
```

#### Write the file to a .tif to export to QGIS
```{r}
writeRaster(sdm_change_ag_585_2080, paste0(HWC_data, "/Geospatial Data/bivariate_outputs/afel_bivariate_585_2080.tif.tif"), overwrite = TRUE)
```
