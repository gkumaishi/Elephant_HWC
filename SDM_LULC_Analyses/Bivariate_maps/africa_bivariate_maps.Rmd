...
#### Write the file to a .tif to export to QGIS
```{r}
writeRaster(sdm_change_ag_585_2020, paste0(HWC_data, "/Geospatial Data/bivariate_outputs/afel_sdm_change_ag_126_2020.tif"), overwrite = TRUE)
```
...
#### Write the file to a .tif to export to QGIS
```{r}
writeRaster(sdm_change_ag_585_2050, paste0(HWC_data, "/Geospatial Data/bivariate_outputs/afel_sdm_change_ag_126_2080.tif"), overwrite = TRUE)
```
