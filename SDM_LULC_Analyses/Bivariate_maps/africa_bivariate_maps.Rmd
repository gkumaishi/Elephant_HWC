...
```{r}
writeRaster(baseline_urban_bivariate, "G:/.shortcut-targets-by-id/1YB-Hz3L-kWyiZMg2UM89GQkvqXyZUW1H/HWC_data/Geospatial Data/bivariate_outputs/afel_urban_bivariate_baseline.tif", overwrite = TRUE)
```
