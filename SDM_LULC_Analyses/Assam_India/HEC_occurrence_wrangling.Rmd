...
# Goalpara
goalpara_HEC_raw <- read.csv(file = "/Volumes/GoogleDrive/.shortcut-targets-by-id/1YB-Hz3L-kWyiZMg2UM89GQkvqXyZUW1H/HWC_data/Geospatial Data/Assam_India/Goalpara_HEC.csv")

# Sonitpur
sonitpur_HEC_raw <- read.csv(file = "/Volumes/GoogleDrive/.shortcut-targets-by-id/1YB-Hz3L-kWyiZMg2UM89GQkvqXyZUW1H/HWC_data/Geospatial Data/Assam_India/Sonitpur_HEC.csv")
```
...
write_csv(goalpara_HEC_tidy, "/Volumes/GoogleDrive/.shortcut-targets-by-id/1YB-Hz3L-kWyiZMg2UM89GQkvqXyZUW1H/HWC_data/Geospatial Data/Assam_India/Goalpara_HEC_tidy.csv")
```
...
write_csv(sonitpur_HEC_tidy, "/Volumes/GoogleDrive/.shortcut-targets-by-id/1YB-Hz3L-kWyiZMg2UM89GQkvqXyZUW1H/HWC_data/Geospatial Data/Assam_India/Sonitpur_HEC_tidy.csv")
```
