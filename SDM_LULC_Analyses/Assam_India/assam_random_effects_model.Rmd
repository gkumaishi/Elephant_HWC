...
### Find centroids of cells in SpatVector
```{r}
assam_centroids <- centroids(assam_HEC_reproj)
```
...
### Euclidean distance on vector using correct coordinate system (to give you a raster)
```{r}
